...
/* harmony import */ var _modules_moreStyles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/moreStyles */ "./src/js/modules/moreStyles.js");
...
/* harmony import */ var _modules_hoverPic__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/hoverPic */ "./src/js/modules/hoverPic.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var obj = {};
  Object(_modules_carousel__WEBPACK_IMPORTED_MODULE_0__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
  Object(_modules_carousel__WEBPACK_IMPORTED_MODULE_0__["default"])('.main-slider-item', 'vertical');
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_form__WEBPACK_IMPORTED_MODULE_2__["default"])('form', obj);
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modules_moreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '.styles .row', 'col-sm-3 col-sm-offset-0 col-xs-10 col-xs-offset-1', 'hidden-lg hidden-md hidden-sm hidden-xs styles-2');
  Object(_modules_calculator__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', obj);
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_7__["default"])('.portfolio-menu', '.portfolio-block');
  Object(_modules_hoverPic__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block', '.sizes-block img');
...
var accordion = function accordion(header) {
  ...
  headers.forEach(function (header) {
    header.addEventListener('click', function () {
      ...
      headers.forEach(function (header) {
        if (!_this.classList.contains('ui-accordion-header-active')) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calculator = function calculator(sizeSelector, materialSelector, optionsSelector, promoSelector, resultSelector, obj) {
  ...
  function calcRes() {
    var res = price[size.value] + price[material.value];
...
var carousel = function carousel(slides, dir, prev, next) {
  var slideIndex = 1,
      paused;
  ...
  moveSlidesAuto();
  slideItems[0].parentNode.addEventListener('mouseenter', function () {
    clearInterval(paused);
  });
  slideItems[0].parentNode.addEventListener('mouseleave', function () {
    moveSlidesAuto();
  });
};
...
var drop = function drop() {
  var inputFiles = document.querySelectorAll('[name="upload"]');
  ...
  document.querySelector('.main input').addEventListener('change', function () {
    postFile(this);
  });
...
var form = function form(formSelector, obj) {
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      console.log(api);
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (data) {
        return console.log(data);
      }).then(function () {
      ...
      if (form.classList.contains('calc_form')) {
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(path.question, formData).then(function (data) {
          return console.log(data);
...
var hoverPic = function hoverPic(blockSelector, imgSelector) {
  ...
  function showPic(block) {
    var pic = block.querySelector('img');
    pic.src = pic.src.slice(0, -4) + '-1.png';
    block.querySelectorAll('p:not(.sizes-hit)').forEach(function (par) {
  ...
  blocks.forEach(function (block) {
    block.addEventListener('mouseover', showPic.bind(_this, block));
    block.addEventListener('mouseout', hidePic.bind(_this, block));
  });
};

/* harmony default export */ __webpack_exports__["default"] = (hoverPic);
...
var mask = function mask(selector) {
  ...
  function createMask(event) {
    ...
    event.target.addEventListener('click', function () {
      setCursorPosition(_this.value.length, _this);
    });
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var deleteOpenSelector = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    openBtn.forEach(function (button) {
      button.addEventListener('click', function () {
        ...
        document.querySelector('.fixed-gift').style.right = "calc(2rem + ".concat(scrollWidth, "px)");
        btnPressed = true;
  ...
  function showModalOnScroll(selector, deleteOpenSelector) {
    window.addEventListener('scroll', function () {
      var scrollHeight = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight); // Для оптимизации под старые браузеры(см. режимы браузера)

      var sum = window.pageYOffset + document.documentElement.clientHeight;
...
var moreStyles = function moreStyles(btnSelector, parentSelector, visibleClass) {
  var elemsParent = document.querySelector(parentSelector),
  ...
  btnMore.addEventListener('click', function () {
    ...
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["getResource"])('http://localhost:3000/styles').then(function (response) {
      return createCard(response.styles);
    }).catch(function (error) {
...
var scrolling = function scrolling(selector) {
  var upElem = document.querySelector(selector);
  window.addEventListener('scroll', function () {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (e) {
      ...
      function step(time) {
        ...
        console.log("time: ".concat(time, ", start: ").concat(start, ", progress: ").concat(progress, ", toBlock: ").concat(toBlock));
...
var tabs = function tabs(tabItemSelector, tabContentSelector) {
  var tabItem = document.querySelector(tabItemSelector),
  ...
  function showTabContent(actualClass) {
    ...
    tabItem.children.forEach(function (item) {
      item.classList.add('animated', 'fadeIn');
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could not fetch ".concat(url, ", error").concat(res.status));
